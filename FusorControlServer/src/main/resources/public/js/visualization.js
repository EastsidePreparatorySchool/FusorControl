...
var vizChannels = {
    ...
    'HV-RELAY.in': {name: 'HV relay', shortname: 'HV relay', unit: '', min: 0, max: 1.8, type: "discrete", datatype: "boolean"},
...
//    'SENSORARRAY.gc3': {name: 'GC3 (outside) (cps)', shortname: 'GC3 outside', unit: 'cps', min: 0, max: 250, type: "discrete trailing", datatype: "numeric", graph: "yes"},
    'SENSORARRAY.hfm': {name: 'HFM', shortname: 'hfm', unit: 'ADC V', factor: 1, min: 0, max: 5, type: "continuous", datatype: "numeric", graph: "yes"},
