...
var vizChannels = {
    ...
    'VARIAC.input_volts': {name: 'Variac target (V)', shortname: 'VAR target', unit: 'V', min: 0, max: 130, type: "discrete", datatype: "numeric", graph: "yes"},
    'VARIAC.dial_volts': {name: 'Variac dial (V)', shortname: 'VAR dial', unit: 'V', min: 0, max: 130, type: "discrete", datatype: "numeric", graph: "yes"},
